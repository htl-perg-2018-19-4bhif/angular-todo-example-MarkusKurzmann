...
const people: IPerson[] = [{name: 'Adam'}, {name: 'Eve'}, {name: "Me"}];
const todos: ITodoItem[] = [{id:0, assignedTo:"Me",description:"TestTodo01",dueDate: new  Date ("2014-10-10"),done: false}, 
                            {id:1, assignedTo:"Eve",description:"TestTodo02",dueDate: new  Date ("2014-10-10"),done: false}];
let lastId = 2;
